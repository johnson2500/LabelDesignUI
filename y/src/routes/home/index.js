...
export async function getImageUrl(e, endpoint) {
...
export default () => {
	...
	const [dalle2Url, setDalle2Url] = useState(null);
	const [dalle3Url, setDalle3Url] = useState(null);
	const [diffusionUrl, setDiffusionUrl] = useState(null);
