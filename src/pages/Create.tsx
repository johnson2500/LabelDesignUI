  ...
  return (
    <div class="container mx-auto mt-10" >
      <div class="container item mx-auto mt-10 bg-gray-100 rounded shadow-md" >
        <form onSubmit={handleSubmitGenerate} class="space-y-4 p-6 bg-gray-100 rounded shadow-md">
          <div class="mb-4">
            <label class="block mb-1 font-medium">Prompt</label>
            <input name="create-prompt" type="text" required class="border p-2 w-full rounded" />
          </div>
